...
class WorkerService final {
 public:
  ...
  typedef WithAsyncMethod_handshake<Service > AsyncService;
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_handshake<Service > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_handshake<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_handshake<Service > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_handshake<Service > StreamedService;
};
