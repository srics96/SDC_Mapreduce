...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_central_2eproto[2];
...
const char descriptor_table_protodef_central_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "message\030\001 \001(\t2L\n\rWorkerService\022;\n\thandsh"
  "ake\022\026.mapr.HandShakeRequest\032\024.mapr.HandS"
  "hakeReply\"\000b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_central_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_central_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_central_2eproto = {
  false, false, descriptor_table_protodef_central_2eproto, "central.proto", 179,
  &descriptor_table_central_2eproto_once, descriptor_table_central_2eproto_sccs, descriptor_table_central_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_central_2eproto::offsets,
  file_level_metadata_central_2eproto, 2, file_level_enum_descriptors_central_2eproto, file_level_service_descriptors_central_2eproto,
};
